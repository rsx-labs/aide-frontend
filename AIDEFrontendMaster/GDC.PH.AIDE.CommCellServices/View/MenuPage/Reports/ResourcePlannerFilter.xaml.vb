...
Public Class ResourcePlannerFilter
...
#Region "Events"
    Private Sub btnUpdate_Click(sender As Object, e As RoutedEventArgs) Handles btnUpdate.Click
        Try
            ...
            Dim fiscalYear As String = cbYear.SelectedValue.Substring(0, 4)
            ...
            If output.Contains("Report generated") Then 'Replace text with the text that shows it was successful in the command prompt
                ...
                If result = 6 Then
                    Process.Start("C:\GeneratedReports\Retail Services Resource Planner.xlsx")
                End If
            Else
                'blocker_failed.Show()
