...
#Region "Events"
    ...
    Private Sub cbMonth_DropDownClosed(sender As Object, e As EventArgs) Handles cbMonth.DropDownClosed
        If cbMonth.SelectedValue <> 0 Then
    ...
    Private Sub btnUpdate_Click(sender As Object, e As RoutedEventArgs) Handles btnUpdate.Click
        Try
            ...
            processStartInfo.Arguments = CStr(cbDateRange.SelectedValue)
            ...
            If output.Contains("Report generated") Then 'Replace text with the text that shows it was successful in the command prompt
                ...
                If result = 6 Then
                    Process.Start("C:\GeneratedReports\DEV Weekly Status Report.xlsx")
                End If
            Else
                'blocker_failed.Show()
    ...
    Private Sub cbYear_DropDownClosed(sender As Object, e As EventArgs) Handles cbYear.DropDownClosed
        If cbMonth.SelectedValue <> 0 And cbYear.SelectedValue <> Nothing Then
            cbDateRange.IsEnabled = True
            LoadWeeks()
        End If
