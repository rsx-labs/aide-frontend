...
#Region "Events"
    Private Sub btnUpdate_Click(sender As Object, e As RoutedEventArgs) Handles btnUpdate.Click
        Try
            ...
            Dim finalempID As String
            If cbNickname.SelectedValue = 0 Then
                finalempID = allEmpId
            Else
                finalempID = CStr(empId)
            End If
            ...
            processStartInfo.CreateNoWindow = False 'Dont show the cmd window when the program is running
            ...
            If output.Contains("Report generated") Then 'Replace text with the text that shows it was successful in the command prompt
                ...
                If result = 6 Then
                    Process.Start("C:\GeneratedReports\Retail Services DEV Hardware Inventory.xlsx")
                End If
            Else
                'blocker_failed.Show()
...
#Region "Functions"
    ...
    Public Sub LoadStatus()
        ...
        cbStatus.Items.Add(New With {.Text = "Partially Unassigned", .Value = 4})
