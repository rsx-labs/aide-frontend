...
Public Class ImprovementsFilter
...
#Region "Constructor"
    Public Sub New(_reportsmodel As ReportsModel, mainFrame As Frame, _profile As Profile, _fromPage As String, _addframe As Frame, _menugrid As Grid, _submenuframe As Frame)
        ...
        If Me.fromPage = "Concerns" Then
            tbSuccessForm.Text = "3Cs Filter"
        ElseIf Me.fromPage = "ActionsList" Then
            tbSuccessForm.Text = "Actions List Filter"
        ElseIf Me.fromPage = "Success" Then
            tbSuccessForm.Text = "Success Register Filter"
        ElseIf Me.fromPage = "LessonsLearnt" Then
            tbSuccessForm.Text = "Lessons Learnt Filter"
        ElseIf Me.fromPage = "Commendations" Then
            tbSuccessForm.Text = "Commendations Filter"
        End If
...
#Region "Events"
    Private Sub btnUpdate_Click(sender As Object, e As RoutedEventArgs) Handles btnUpdate.Click
        Try
            ...
            'Check to see if the text contains whatever the program shows in the cmd window to show it was successful
            If output.Contains("Report generated") Or output.Contains("Data retrieval done.") Then 'Replace text with the text that shows it was successful in the command prompt
                result = MsgBox("Report has been downloaded. Open the Report Now?", MessageBoxButton.YesNo, "AIDE")
                If result = 6 Then
                    If Me.fromPage = "Concerns" Then
                        Process.Start("C:\GeneratedReports\Retail Services 3Cs List.xlsx")
                    ElseIf Me.fromPage = "ActionsList" Then
                        Process.Start("C:\GeneratedReports\Retail Services Action List.xlsx")
                    ElseIf Me.fromPage = "Success" Then
                        Process.Start("C:\GeneratedReports\Retail Services Success Registers.xlsx")
                    ElseIf Me.fromPage = "LessonsLearnt" Then
                        Process.Start("C:\GeneratedReports\Retail Services Lesson Learnt.xlsx")
                    ElseIf Me.fromPage = "Commendations" Then
                        Process.Start("C:\GeneratedReports\Retail Services Commendation List.xlsx")
                    End If
