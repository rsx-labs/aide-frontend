...
#Region "Sub Methods"
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            Dim lstProjects As Project() = CommonUtility.Instance().Projects(2) 'AideClient.GetClient().GetProjectList(empID, displayStatus)
        ...
        If ValidateFields() Then
            Try
                ...
                If GetDataContext(Me.DataContext) Then
                    AideClient.GetClient().CreateTask(tasks)
    ...
    Private Sub btnUpdate_Click(sender As Object, e As RoutedEventArgs) Handles btnUpdate.Click
        If ValidateFields() Then
            Try
                ...
                'If InitializeService() Then
                If GetDataContext(Me.DataContext) Then
                    AideClient.GetClient().UpdateTask(tasks)
