...
#Region "Constructor"
    Public Sub New(_mainFrame As Frame, _profile As Profile, _addframe As Frame, _menugrid As Grid, _submenuframe As Frame, _problemModel As ProblemModel)
        ...
        probTitle.Text = _problemModel.PROBLEM_DESCR
        RootCauseTitleTxt.Text = _problemModel.CAUSE_DESCR
        RootCauseDescrTxt.Text = _problemModel.CAUSE_WHY
    End Sub
#End Region
...
#Region "Methods"
    ...
    Public Function setData() As Problem
        Try
            ...
            _problem.CauseID = probMod.CAUSE_ID
            _problem.ProblemID = probMod.PROBLEM_ID
            _problem.CauseDescr = RootCauseTitleTxt.Text
            _problem.CauseWhy = RootCauseDescrTxt.Text
            Return _problem
        Catch ex As Exception
            MsgBox("An application error was encountered. Please contact your AIDE Administrator.", vbOKOnly + vbCritical, "AIDE")
        End Try
