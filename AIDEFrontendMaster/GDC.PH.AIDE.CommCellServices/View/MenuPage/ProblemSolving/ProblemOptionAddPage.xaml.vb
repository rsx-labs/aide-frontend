...
#Region "Events"
    ...
    Private Sub CreateBtn_Click(sender As Object, e As RoutedEventArgs) Handles CreateBtn.Click
        Try
            If OptionDescrTxt.Text = String.Empty Then
            ...
            Else
                ...
                AideClient.GetClient().InsertProblemOption(_problem)
                MsgBox("Option has been added.", vbOKOnly + vbInformation, "AIDE")
                ExitPageReload()
                'End If
            End If
...
#Region "Methods"
    ...
    Public Function setData() As Problem
        Try
            ...
            _problem.OptionDescr = OptionDescrTxt.Text
