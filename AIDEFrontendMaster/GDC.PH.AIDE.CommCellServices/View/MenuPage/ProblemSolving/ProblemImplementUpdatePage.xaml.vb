...
Class ProblemImplementUpdatePage
...
#Region "Constructor"
    Public Sub New(_mainFrame As Frame, _profile As Profile, _addframe As Frame, _menugrid As Grid, _submenuframe As Frame, _problemModel As ProblemModel)
        ...
        Me.ImplementDetailTxt.Text = _problemModel.IMPLEMENT_DESCR
        Me.ImplementValueTxt.Text = _problemModel.IMPLEMENT_VALUE
    End Sub
#End Region
...
#Region "Methods"
    ...
    Public Function setData() As Problem
        Try
            ...
            _problem.ImplementID = probMod.IMPLEMENT_ID
            _problem.ProblemID = probMod.PROBLEM_ID
            _problem.OptionID = probMod.OPTION_ID
            _problem.ImplementDescr = ImplementDetailTxt.Text
            _problem.ImplementAssignee = profile.Emp_ID
            _problem.ImplementValue = ImplementValueTxt.Text
            Return _problem
        Catch ex As Exception
            MsgBox("An application error was encountered. Please contact your AIDE Administrator.", vbOKOnly + vbCritical, "AIDE")
        End Try
